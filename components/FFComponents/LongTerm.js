        ...
        <View style={styles.fullWidth}>
            ...
            { hasltc ? <>
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flex:.5}}>
                        <TextInput style={styles.textInputStyle} value={ecareprem1} onChangeText={(value) => {setecareprem1(value)}}/>
                    </View>
                </View>
                {hasspouse ? <> 
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flex:.5}}>
                        <TextInput style={styles.textInputStyle} value={ecareprem2} onChangeText={(value) => {setecareprem2(value)}}/>
                    </View>
                </View>
                </>: null}
            </> : null}
